...
<div class="container-fluid">
	<div class="row">
		...
		<div class="col-md-8" style="background: #a3d1f1;">
            ...
            <a href="<?php echo get_home_url() . '/account/request?action=add'?>"><button class="btn" style="border: 1px solid #3858e9; color: #3858e9;">درخواست جدید</button></a><hr>
			...
			<?php
				...
				insertSearchPagination(home_url('account/request/'), $current_page, $total_page, true);
			?>
